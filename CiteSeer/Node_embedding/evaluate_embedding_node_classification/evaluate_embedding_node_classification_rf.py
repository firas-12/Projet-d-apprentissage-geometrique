...
def evaluate_embedding_node_classification_rf(embedding_matrix, labels, train_ratio=0.1, norm=True, seed=0, n_repeats=10):
    """Evaluate the node embeddings on the node classification task using Random Forest."""
    ...
    for it_seed in range(n_repeats):
        ...
        print(f"Classification Report for Random Forest (seed {it_seed + 1}):")
